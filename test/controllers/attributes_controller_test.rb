...
class AttributesControllerTest < ActionController::TestCase
  ...
  test "should create attribute" do
    assert_difference('Attribute.count') do
      post :create, attribute: { created_at: @attribute.created_at, description: @attribute.description, is_correct: @attribute.is_correct, question_id: @attribute.question_id, score: @attribute.score, updated_at: @attribute.updated_at }
    end
  ...
  test "should update attribute" do
    patch :update, id: @attribute, attribute: { created_at: @attribute.created_at, description: @attribute.description, is_correct: @attribute.is_correct, question_id: @attribute.question_id, score: @attribute.score, updated_at: @attribute.updated_at }
    assert_redirected_to attribute_path(assigns(:attribute))
  end
