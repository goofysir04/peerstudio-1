...
!function ($) {
  ...
  , showPreview: function() {
      ...
      var changePreviewTitle = function(el) {el.html('<span class="glyphicon glyphicon-edit"></span> Return to Editing')}        

      this.__alterButtons("cmdPreview", changePreviewTitle)
  ...
  , hidePreview: function() {
      ...
      var changePreviewTitle = function(el) {el.html('<span class="glyphicon glyphicon-search"></span> Preview')}
      ...
      [{
        ...
        data: [{
          ...
          callback: function(e){
            ...
            link = prompt('Insert Image Hyperlinks (Use the "Attach a file" button to upload files)','http://')
